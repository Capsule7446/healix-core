...
func sealedCoordinatorPlan(t *testing.T) execution.InstanceSnapshot {
	...
	draft := execution.PlanSnapshot{RunID: "run", FailurePolicy: execution.FailurePolicyStopOnFailure, Entries: []execution.Entry{{ExecutionID: "execution-1", TestTaskItemID: "item-1", SequenceNumber: 1, FlowFragmentID: "workflow", WorkflowVersionID: "workflow-v1"}}, Workflows: []execution.WorkflowSnapshot{workflow}}
