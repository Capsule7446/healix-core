...
func TestCompilePlanBuildsCompleteStepTreeWithoutAliasingPlan(t *testing.T) {
	...
	plan := execution.PlanSnapshot{InstanceID: mustInstanceID("execution"), FailurePolicy: execution.FailurePolicyStopOnFailure, Entries: []execution.Entry{{ID: mustEntryID("execution-entry"), TestTaskItemID: "task-item", SequenceNumber: 1, FlowFragmentID: "root", WorkflowVersionID: "root-v1"}},
