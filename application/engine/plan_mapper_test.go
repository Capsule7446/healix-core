...
func TestCompilePlanRequiresRunIdentity(t *testing.T) {
	if _, err := compileDraft(execution.PlanSnapshot{Entries: []execution.Entry{{ExecutionID: "execution-entry", TestTaskItemID: "task-item", FlowFragmentID: "root", WorkflowVersionID: "root"}}}); err == nil {
