...
func TestDraftValidatePublicRuleMatrix(t *testing.T) {
	...
	base := func() PlanSnapshot { return validDraftWithNodes(validNodeSnapshot(nodeID, "v1")) }
	tests := []struct {
		name   string
		...
		{name: "invalid failure policy", build: base, mutate: func(value *PlanSnapshot) { value.FailurePolicy = "UNKNOWN" }, want: "invalid failure policy"},
		{name: "missing entries", build: base, mutate: func(value *PlanSnapshot) { value.Entries = nil }, want: "at least one entry"},
		...
		{name: "duplicate workflow version", build: base, mutate: func(value *PlanSnapshot) { value.Workflows = append(value.Workflows, value.Workflows[0]) }, want: "duplicate workflow version"},
		...
		{name: "duplicate node dependency", build: base, mutate: func(value *PlanSnapshot) { value.Nodes = append(value.Nodes, value.Nodes[0]) }, want: "duplicate node dependency"},
		{name: "duplicate workflow resolution", build: base, mutate: func(value *PlanSnapshot) {
		...
		{name: "unowned workflow resolutions are sorted", build: base, mutate: func(value *PlanSnapshot) {
