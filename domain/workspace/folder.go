...
func (folder WorkspaceFolder) Validate() error {
...
func NewFolderForest(folders []WorkspaceFolder) (FolderForest, error) {
	byID := make(map[string]WorkspaceFolder, len(folders))
